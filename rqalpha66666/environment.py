...
from rqalpha66666.events import EventBus
from rqalpha66666.utils import get_account_type
from rqalpha66666.utils.logger import system_log, user_log, user_detail_log
...
class Environment(object):
    ...
    def get_plot_store(self):
        if self.plot_store is None:
            from rqalpha66666.utils.plot_store import PlotStore
