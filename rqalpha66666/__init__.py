...
from rqalpha66666.__main__3333 import cli
from rqalpha66666.api.api_base import export_as_api, subscribe_event
...
def load_ipython_extension(ipython):
    """call by ipython"""
    from rqalpha66666.__main__3333 import inject_mod_commands
    inject_mod_commands()
...
def update_bundle(data_bundle_path=None, locale="zh_Hans_CN", confirm=True):
    ...
    rqalpha66666.utils.bundle_helper.update_bundle(data_bundle_path=data_bundle_path, locale=locale, confirm=confirm)


def run(config, source_code=None):
    # [Deprecated]
    from rqalpha66666.utils.config import parse_config
...
def run_ipython_cell(line, cell=None):
    from rqalpha66666.__main__3333 import run
    from rqalpha66666.utils.py2 import clear_all_cached_functions
...
def run_func(**kwargs):
    from rqalpha66666.utils import dummy_func
    from rqalpha66666.utils.py2 import clear_all_cached_functions
    from rqalpha66666.utils.config import parse_config
    from rqalpha66666 import main
