...
from rqalpha66666.const import RUN_TYPE, PERSIST_MODE, MARKET, COMMISSION_TYPE
from rqalpha66666.utils import RqAttrDict, logger
from rqalpha66666.utils.i18n import gettext as _, localization
from rqalpha66666.utils.dict_func import deep_update
from rqalpha66666.utils.py2 import to_utf8
from rqalpha66666.utils.logger import system_log
from rqalpha66666.mod.utils import mod_config_value_parse
...
def set_locale(lc):
    ...
    try:
        ...
        locale.setlocale(locale.LC_CTYPE, "C.UTF-8")#locale.setlocale(locale.LC_CTYPE, "en_US.UTF-8")
