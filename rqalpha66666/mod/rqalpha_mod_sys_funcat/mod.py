...
from rqalpha66666.const import EXECUTION_PHASE
...
class FuncatAPIMod(AbstractMod):
    def start_up(self, env, mod_config):
        ...
        from rqalpha66666.api import history_bars
        ...
        from rqalpha66666.api.api_base import register_api
